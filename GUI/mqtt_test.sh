#! /bin/bash
input_file=logs/Walking_Slow2_0_48.csv
while IFS=, read -r col1 col2 col3 col4 col5 col6 col7 col8 col9 col10 col11 col12 col13 col14
do
	json_packet="{\"packet_num\":10,\"size\":1,\"ax_t\":[$col1],\"ay_t\":[$col2],\"az_t\":[$col3],\"ax_b\":[$col4],\"ay_b\":[$col5],\"az_b\":[$col6],\"fq\":[$col7],\"fh\":[$col8],\"gx_t\":[$col9],\"gy_t\":[$col10],\"gz_t\":[$col11],\"gx_b\":[$col12],\"gy_b\":[$col13],\"gz_b\":[$col14]}"
	echo $json_packet
