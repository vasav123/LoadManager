...
class Ui_recordControl(object):
    def setupUi(self, recordControl):
        ...
        self.score = QtWidgets.QLCDNumber(self.groupBox)
        self.score.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.score.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.score.setProperty("intValue", 100)
        self.score.setObjectName("score")
        self.gridLayout_2.addWidget(self.score, 5, 1, 1, 1)
        ...
        self.horizontalSlider_3.sliderMoved['int'].connect(self.score.display)
