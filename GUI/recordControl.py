...
class Ui_recordControl(object):
    def setupUi(self, recordControl):
        ...
        self.horizontalSlider_2.setMinimum(75)
        self.horizontalSlider_2.setMaximum(150)
        self.horizontalSlider_2.setSliderPosition(98)
        ...
        self.weight = QtWidgets.QLCDNumber(self.groupBox)
        self.weight.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.weight.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.weight.setProperty("intValue", 98)
        self.weight.setObjectName("weight")
        self.gridLayout_2.addWidget(self.weight, 3, 1, 1, 1)
        ...
        self.horizontalSlider.setMinimum(150)
        self.horizontalSlider.setMaximum(240)
        self.horizontalSlider.setSliderPosition(176)
        self.horizontalSlider.setOrientation(QtCore.Qt.Horizontal)
        self.horizontalSlider.setInvertedAppearance(False)
        self.horizontalSlider.setObjectName("horizontalSlider")
        self.gridLayout_2.addWidget(self.horizontalSlider, 2, 0, 1, 2)
        self.height = QtWidgets.QLCDNumber(self.groupBox)
        self.height.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.height.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.height.setProperty("value", 176.0)
        self.height.setProperty("intValue", 176)
        self.height.setObjectName("height")
        self.gridLayout_2.addWidget(self.height, 1, 1, 1, 1)
        self.verticalLayout.addWidget(self.groupBox)
        self.horizontalLayout_8.addWidget(self.frame)

        self.retranslateUi(recordControl)
        self.horizontalSlider.sliderMoved['int'].connect(self.height.display)
        self.horizontalSlider_2.sliderMoved['int'].connect(self.weight.display)
        self.horizontalSlider_3.sliderMoved['int'].connect(self.maxScore.display)
    ...
    def retranslateUi(self, recordControl):
        ...
        self.label_3.setText(_translate("recordControl", "Weight (kg)"))
        self.label_2.setText(_translate("recordControl", "Height (cm)"))
