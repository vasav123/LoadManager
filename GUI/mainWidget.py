...
"qproperty-alignment: AlignCenter;")
        ...
        self.Record.setMinimumSize(QtCore.QSize(150, 60))
        self.Record.setMaximumSize(QtCore.QSize(9999, 60))
        font = QtGui.QFont()
        font.setFamily("Bitstream Vera Sans")
        ...
        self.Record.setFlat(False)
        self.Record.setObjectName("Record")
        self.horizontalLayout.addWidget(self.Record, 0, QtCore.Qt.AlignRight)
