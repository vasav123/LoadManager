...
class Ui_playerStats(object):
    def setupUi(self, playerStats):
        ...
        self.aveVelocity = QtWidgets.QLCDNumber(self.groupBox_6)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.aveVelocity.sizePolicy().hasHeightForWidth())
        self.aveVelocity.setSizePolicy(sizePolicy)
        self.aveVelocity.setObjectName("aveVelocity")
        self.horizontalLayout_4.addWidget(self.aveVelocity)
    ...
    def retranslateUi(self, playerStats):
        ...
        self.label_3.setText(_translate("playerStats", "Average Velocity in Last 5s"))
